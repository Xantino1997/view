...
function removeListItem() {
  ...
  var visorGeneral = document.getElementById("visorGeneral")
  var visorPequeño = document.getElementById("visorPequeño")
  ...
  try {
    ...
    if (imgGeneral) {
      visorGeneral.parentNode.removeChild(visorGeneral);
    ...
    if (imgPequeño) {
      visorPequeño.parentNode.removeChild(visorPequeño);
      var newImgGeneral = newListItem.getElementsByTagName("img")[0];
      var newImgPequeño = newListItem.getElementsByTagName("img")[0];
      visorGeneral.appendChild(newImgGeneral);
      visorPequeño.appendChild(newImgPequeño);
